#Assignment 2
###Description
This repository contains two directories Assignment 1 and Assignment 2 which are my submissions of the respective assignments given in the Discrete Mathematics project under the STAMATICS society.
###Assignment 2
...
**public1.knp,public2.knp,public3.knp,public4.knp**: Some sample Kanpur program to test the lexical analyzer.
...
>./probl1 public1.knp
>>
Replace example.knp with your own Kanpur source file if needed.
